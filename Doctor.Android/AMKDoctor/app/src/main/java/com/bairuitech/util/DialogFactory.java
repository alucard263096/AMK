...
public class DialogFactory {
	...
	public void initConfigDialog(final Dialog dialog, final Object object) {
		...
		View view = mLayoutInlater.inflate(
		  com.helpfooter.steve.amkdoctor.R.layout.dialog_config, null);
	...
	public void initCallResume(final Dialog dialog, Object object) {
		final UserItem userItem = (UserItem) object;
		...
		btnCall.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				BussinessCenter.VideoCallControl(AnyChatDefine.BRAC_VIDEOCALL_EVENT_REQUEST, userItem.getUserId(), 0,	0, 0, "");
				mDialog.dismiss();
			}
		});
		String strTitle = "";

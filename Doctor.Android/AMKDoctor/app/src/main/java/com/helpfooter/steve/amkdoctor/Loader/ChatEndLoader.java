...
public class ChatEndLoader extends WebXmlLoader {

	private int OrderId;
	public ChatEndLoader(Context ctx) {
		super(ctx, "");
	}
    public ChatEndLoader(Context ctx, int orderid)
	{
		super(ctx,"");
	    OrderId=orderid;
	...
	public String getCallUrl() {
		...
		String url=StaticVar.dictHashMap.get("ChatEnd");

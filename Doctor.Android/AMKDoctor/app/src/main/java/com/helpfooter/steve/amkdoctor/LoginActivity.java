 ...
 */
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor>,IWebLoaderCallBack {
    ...
    public void attemptLogin() {
        ...
        DoctorLoader dl = new DoctorLoader(this.getApplicationContext(),email);
        threadstatus="Login";
        dl.setCallBack(this);
        dl.start();
    ...
    private android.os.Handler FirstcodeHandler = new android.os.Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            }else  if (!doj.getPassWord().equals(ToolsUtil.Encryption(password))) {

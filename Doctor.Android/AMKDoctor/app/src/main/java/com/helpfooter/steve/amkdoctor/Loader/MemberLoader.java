...
public class MemberLoader extends WebXmlLoader {
	...
	public MemberLoader(Context ctx) {
		super(ctx, "");
	}
    public MemberLoader(Context ctx, String member_id)
	{
		super(ctx,"");
		MemberId=member_id;
	}
...
//
	...
	public String getCallUrl() {
		...
		String url="http://www.myhkdoc.com/AMK/API/Member/member_get.php?member_id="+MemberId;
		Log.i("callurl", url);
		return url;
	}
//

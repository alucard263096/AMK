...
public class ChatEndTimeLoader extends WebXmlLoader {

	private int OrderId;
	private int Mini;
	public ChatEndTimeLoader(Context ctx) {
		super(ctx, "");
	}
    public ChatEndTimeLoader(Context ctx, int orderid,int min)
	{
		super(ctx,"");
	    OrderId=orderid;
		Mini=min;
	...
	public String getCallUrl() {
		...
		String url=StaticVar.dictHashMap.get("ChatEndTime");



			url= url+"?order_id="+String.valueOf(OrderId)
					+"&minute="+String.valueOf(Mini);

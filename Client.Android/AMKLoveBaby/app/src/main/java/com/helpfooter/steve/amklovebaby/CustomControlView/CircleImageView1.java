...
public class CircleImageView1 extends ImageView {
    ...
    private static final int DEFAULT_BORDER_COLOR = Color.parseColor("#919191");
    ...
    private void setup() {
        ...
        mFlagBackgroundPaint.setColor(Color.parseColor("#919191"));
        ...
        mSweepGradient = new SweepGradient(getWidth() / 2, getHeight() / 2,
                new int[] {Color.parseColor("#919191"), Color.parseColor("#919191") },
                null);
